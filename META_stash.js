...
function generateServiceRuleProviders(services, defaultConfig) {
    return services.reduce((acc, { name, alias }) => {
        ...
        acc[name.toLowerCase()] = {
            ...
            format: "yaml",
            behavior: "domain",
            url: `https://cdn.jsdelivr.net/gh/xixu-me/rulesets-for-META@universal/yaml/${ruleName.toLowerCase()}.yaml`,
            path: `./rulesets/${name.toLowerCase()}.yaml`,
        };
        return acc;
    }, {});
}
...
const ruleProviders = {
    ...
    lancidr: {
        ...
        format: "yaml",
        behavior: "ipcidr",
        url: "https://cdn.jsdelivr.net/gh/xixu-me/rulesets-for-META@basic/yaml/lancidr.yaml",
    ...
    cncidr: {
        ...
        format: "yaml",
        behavior: "ipcidr",
        url: "https://cdn.jsdelivr.net/gh/xixu-me/rulesets-for-META@basic/yaml/cncidr.yaml",
    ...
    cloudflarecidr: {
        ...
        format: "yaml",
        behavior: "ipcidr",
        url: "https://cdn.jsdelivr.net/gh/xixu-me/rulesets-for-META@basic/yaml/cloudflarecidr.yaml",
        path: "./rulesets/cloudflarecidr.yaml",
    },
    googlecidr: {
        ...ruleProviderDefaults,
        format: "yaml",
        behavior: "ipcidr",
        url: "https://cdn.jsdelivr.net/gh/xixu-me/rulesets-for-META@basic/yaml/googlecidr.yaml",
        path: "./rulesets/googlecidr.yaml",
    },
    xcidr: {
        ...ruleProviderDefaults,
        format: "yaml",
        behavior: "ipcidr",
        url: "https://cdn.jsdelivr.net/gh/xixu-me/rulesets-for-META@basic/yaml/xcidr.yaml",
        path: "./rulesets/xcidr.yaml",
    },
    private: {
        ...ruleProviderDefaults,
        format: "yaml",
        behavior: "domain",
        url: "https://cdn.jsdelivr.net/gh/xixu-me/rulesets-for-META@basic/yaml/private.yaml",
    ...
    direct: {
        ...
        format: "yaml",
        behavior: "domain",
        url: "https://cdn.jsdelivr.net/gh/xixu-me/rulesets-for-META@basic/yaml/direct.yaml",
    ...
    proxy: {
        ...
        format: "yaml",
        behavior: "domain",
        url: "https://cdn.jsdelivr.net/gh/xixu-me/rulesets-for-META@basic/yaml/proxy.yaml",
    ...
    "geolocation-cn": {
        ...
        format: "yaml",
        behavior: "domain",
        url: "https://cdn.jsdelivr.net/gh/xixu-me/rulesets-for-META@universal/yaml/geolocation-cn.yaml",
        path: "./rulesets/geolocation-cn.yaml",
    },
    reject: {
        ...ruleProviderDefaults,
        format: "yaml",
        behavior: "domain",
        url: "https://cdn.jsdelivr.net/gh/xixu-me/rulesets-for-META@basic/yaml/reject.yaml",
    ...
    "win-spy": {
        ...
        format: "yaml",
        behavior: "domain",
        url: "https://cdn.jsdelivr.net/gh/xixu-me/rulesets-for-META@universal/yaml/win-spy.yaml",
        path: "./rulesets/win-spy.yaml",
    },
